...
from model.correction.model import BetterCorrectionModel
...
def better_corr_baseline_train(t0, t1, mp, v0=None, v1=None, p1=None, run=None, **kwargs):
    try:
        ...
        model = BetterCorrectionModel(numerical_features=NUM_FEATURES, ohe_categorical_features=CATEGORICAL_OHE_FEATURES,
...
def better_corr_baseline_predict(p1, mp, o=None, run=None, **kwargs):
    try:
        ...
        model = BetterCorrectionModel.load(mp)
        logger.info('Predict')
