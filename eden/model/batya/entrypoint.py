...
from model.batya.model import BatyaModel
...
def batya_train(t0, t1, mp, v0=None, v1=None, p1=None, run=None, **kwargs):
    _t0 = t0.copy()
    _t1 = t1.copy()
...
def batya_predict(p1, mp, o=None, run=None, **kwargs):
    _p1 = p1.copy()
    logger.info('START predict.py')
    logger.info('Load test df')

    logger.info('Load model')
    model = BatyaModel.load(mp)
    logger.info('Predict')
